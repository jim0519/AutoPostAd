...
namespace AutoPostAdBusiness.Task
{
    ...
    public partial class TaskManager
    {
        ...
        public void Initialize()
        {
            ...
            var taskService = AutoPostAdContext.Instance.Resolve<IScheduleTaskService>();
            ...
            var notRunTasks = scheduleTasks
                ...
                .Where(x => !x.LastStartTime.HasValue || x.LastStartTime.Value.AddSeconds(_notRunTasksInterval) < DateTime.Now)
                .ToList();
